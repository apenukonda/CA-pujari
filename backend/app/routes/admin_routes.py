...
from app.utils.firestore_optimization import get_firestore_client, FirestoreCache, QueryOptimizer, BatchProcessor
from app.utils.firestore_admin import FirestoreAdmin, quick_database_health_check, generate_admin_dashboard_data
...
class ExportRequest(BaseModel):
    ...
    collection: str
    format: str = Field(default="json", regex="^(json|csv|ndjson)$")
